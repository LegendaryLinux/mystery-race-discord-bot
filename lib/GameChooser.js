...
class GameChooser{
    ...
    chooseRandomGame(official, filters){
        ...
        if(typeof(filters.hasNotes) !== 'undefined' && filters.hasNotes) notesSql = "AND notes\n";
        if(typeof(filters.hasGoal) !== 'undefined' && filters.hasGoal) goalSql = "AND goal\n";
        if(typeof(filters.hasEstimate) !== 'undefined' && filters.hasEstimate) estimateSql = "AND estimate\n";
